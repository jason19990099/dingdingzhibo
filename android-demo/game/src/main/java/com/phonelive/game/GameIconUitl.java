...
/**
 * Created by cxf on 2017/10/8.
 */

public class GameIconUitl {
    private static SparseIntArray sGameIngMap;//直播间正在进行的游戏图标
    ...
    static {
        ...
        sGameIngMap = new SparseIntArray();
        sGameIngMap.put(1, R.mipmap.icon_ing_zjh);
        sGameIngMap.put(2, R.mipmap.icon_ing_hd);
        sGameIngMap.put(3, R.mipmap.icon_ing_zp);
        sGameIngMap.put(4, R.mipmap.icon_ing_nz);
        sGameIngMap.put(5, R.mipmap.icon_ing_ebb);
    }

    /**
     * 直播间正在进行的游戏
     */
    public static int getLiveGame(int gameAction) {
        return sGameIngMap.get(gameAction);
    }
