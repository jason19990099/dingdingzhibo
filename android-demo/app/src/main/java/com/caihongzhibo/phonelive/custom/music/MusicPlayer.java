package com.caihongzhibo.phonelive.custom.music;
...
public class MusicPlayer implements View.OnClickListener, View.OnTouchListener {
    ...
    public MusicPlayer(ViewGroup parent, KSYStreamer streamer, Runnable onClose) {
        ...
        L.e("parent-----width---->" + mParentWidth);
        L.e("parent-----height---->" + mParentHeight);
        mStreamer = streamer;
        mOnClose = onClose;
        mView = LayoutInflater.from(AppContext.sInstance).inflate(R.layout.view_live_lrc, mParent, false);
    ...
    public void play(String source, LiveLrcBean bean) {
        ...
        try {
            ...
            e.printStackTrace();
            ToastUtil.show(mContext.getString(R.string.mp3_not_found));
        }
    }
