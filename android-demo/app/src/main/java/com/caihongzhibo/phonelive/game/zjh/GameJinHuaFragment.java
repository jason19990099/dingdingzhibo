...
import com.caihongzhibo.phonelive.fragment.AbsFragment;
import com.caihongzhibo.phonelive.game.GameBetCoinView;
import com.caihongzhibo.phonelive.game.PokerView;
...
public class GameJinHuaFragment extends AbsFragment implements View.OnClickListener {

    private GameJinHuaPresenter mGamePresenter;
    ...
    protected int getLayoutId() {
        return R.layout.game_fragment_zjh;
    }
    ...
    public void setGamePresenter(GameJinHuaPresenter presenter) {
    ...
    private void showEveryResult(int i, String[] result) {
        ...
        mResults[i].setImageResource(GameIconUitl.getJinHuaResult(result[6]));
    ...
    public void onDestroyView() {
        ...
        HttpUtil.cancel(HttpUtil.GAME_JINHUA_CREATE);
        HttpUtil.cancel(HttpUtil.GAME_JINHUA_BET);
