...
import com.caihongzhibo.phonelive.adapter.HomeHotAdapter;
import com.caihongzhibo.phonelive.bean.LiveBean;
import com.caihongzhibo.phonelive.bean.SliderBean;
import com.caihongzhibo.phonelive.custom.RefreshLayout;
...
public class HomeHotFragment extends AbsFragment implements RefreshLayout.OnRefreshListener, MainEventListener {
    ...
    private HttpCallback mRefreshCallback = new HttpCallback() {
        ...
        public void onSuccess(int code, String msg, String[] info) {
            ...
            if (mAdapter == null) {
                mAdapter = new HomeHotAdapter(mContext, sliderList, liveList);
                ...
                mAdapter.setData(sliderList, liveList);
            }
        }
