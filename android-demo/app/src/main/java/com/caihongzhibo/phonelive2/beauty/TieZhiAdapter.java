...
import com.caihongzhibo.phonelive2.utils.TieZhiDownloadUtil;
...
public class TieZhiAdapter extends RecyclerView.Adapter<TieZhiAdapter.Vh> {
    ...
    private TieZhiDownloadUtil mDownloadUtil;
    ...
    public TieZhiAdapter(Context context) {
        ...
        mDownloadUtil = new TieZhiDownloadUtil();
    }
                ...
                public void onClick(View v) {
                    if (!mBean.isDownloaded()) {
                        if (mDownloadUtil != null && mLoadingTaskMap.size() < MAX_DOWNLOAD_TASK &&
                            ...
                            mDownloadUtil.download(name, AppConfig.VIDEO_TIE_ZHI_PATH, name, mBean.getUrl(), new TieZhiDownloadUtil.Callback() {
                                @Override
