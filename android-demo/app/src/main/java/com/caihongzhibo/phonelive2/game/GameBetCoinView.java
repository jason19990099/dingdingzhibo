...
public class GameBetCoinView extends LinearLayout {
    ...
    public GameBetCoinView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mName = ta.getString(R.styleable.GameBetCoinView_name);
        mTextColor = ta.getColor(R.styleable.GameBetCoinView_textColor, 0xff333333);
        mTextSize = ta.getDimension(R.styleable.GameBetCoinView_textSize, 0);
        mMarginTop1 = (int) ta.getDimension(R.styleable.GameBetCoinView_marginTop1, 0);
        mMarginTop2 = (int) ta.getDimension(R.styleable.GameBetCoinView_marginTop2, 0);
        mMarginTop3 = (int) ta.getDimension(R.styleable.GameBetCoinView_marginTop3, 0);
        ta.recycle();
